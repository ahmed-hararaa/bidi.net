...
private static readonly Dictionary<int, List<int>> _decomMapping = new(){
  {0x00A0, [0x0020]},
...
private static readonly Dictionary<String, int> _composeMapping = new(){
  {"\u0020", 0x3000},
  {"\u0020\u0301", 0x0384},
  {"\u0020\u0303", 0x02DC},
  {"\u0020\u0304", 0x00AF},
...
internal static void GetRecursiveDecomposition(bool canonical, int ch, List<int> builder) {
  var decomp = GetDecompositionMapping(ch);
